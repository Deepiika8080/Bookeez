...
const Navbar = () => {
  return (
    <div className='nav-component'>
      <div className=' nav h-[62px] bg-[#ACABA4] flex items-center justify-between'>
        ...
        <div className='flex justify-end'>
          <div className="buy">
            <button className='bg-[#D80032] rounded-md p-2 w-[7rem] hover:bg-[rgb(210,4,4)] text-[#F1FBFB] '><Link href={"/sell"}>Sell</Link></button>
          </div>
          <div className="login">
